...
try {
    ...
    $sql = "DELETE FROM entradas WHERE id IN ($placeholders) AND user_id = ?";
    ...
    error_log("Erro ao deletar várias entradas: " . $e->getMessage());
    http_response_code(500);
    echo json_encode(['success' => false, 'message' => 'Erro ao deletar entradas.']);
}
?>